...
public class ValidateIP{
 ...
 public static String getLocalIPAddress() 
 {
	  ...
	  * Looks like both these peices of code is working only on linux machines and not
	  * on windows. May be you have to do another check for OS if you care.
	  * Strictly it need not be UDP also. You can do a TCP connect() to google.com 
	  * as I told. He TA says UDP, make him happy.
	  */
	try {
	...
	try {
		...
		clientUDPSocket.connect(IPAddress, 53); //53 is the well-known port number used by DNS
